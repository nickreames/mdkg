...
Advanced alpha surfaces are useful for larger agentic workflows, but they are not the first-run path. Use them after the basic Plan -> Work -> Evidence loop is working in a small repository.

- [Demo graphs](demo-graphs.md)
- [Subgraphs and bundles](subgraphs-and-bundles.md)
