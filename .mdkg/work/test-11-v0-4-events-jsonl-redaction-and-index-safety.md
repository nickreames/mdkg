...
id: test-11
type: test
title: v0.4 events jsonl redaction and index safety
status: done
priority: 1
epic: epic-4
...
Validate planned v0.4 episodic logging constraints for JSONL format, seeded init event shape, redaction defaults, and index safety boundaries.
