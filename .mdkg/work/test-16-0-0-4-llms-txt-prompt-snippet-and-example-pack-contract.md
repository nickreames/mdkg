...
id: test-16
type: test
title: 0.0.4 llms txt prompt snippet and example pack contract
status: done
priority: 1
epic: epic-4
...
owners: []
links: []
artifacts: [llms.txt, AGENT_PROMPT_SNIPPET.md, PACK_EXAMPLES.md, README.md, .mdkg/design/prd-2-mdkg-dev-external-docs-handoff-note.md]
...
- Verify docs versioning expectations are captured for `0.0.4` and later-release continuity.
