...
id: chk-527
type: checkpoint
title: Implement atomic accepted-revision Git materialization
...
task-748 was marked done through the mdkg task lifecycle.

# Scope Covered

- Completed node: task-748 (implement atomic materialization revision depth and submodule policies)
- Node type: task
- Checkpoint source: `mdkg task done --checkpoint`

## Changed Surfaces

- Completed work node: task-748
...
- Completion of task-748 was recorded through the structured task lifecycle.
