...
id: chk-246
type: checkpoint
title: Expanded public docs depth: added accessible deterministic Plan -> Work -> Evidence HTML/CSS diagram, valid goal/task frontmatter examples, common mistakes, user-facing reference job chooser, advanced-alpha decision path, and smoke assertions for these contracts. Validation: docs:check-commands and smoke:mdkg-dev-polish-pass5 passed.
