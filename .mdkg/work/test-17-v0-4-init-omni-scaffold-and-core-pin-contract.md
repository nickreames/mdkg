...
id: test-17
type: test
title: v0.4 init omni scaffold and core pin contract
status: done
priority: 1
epic: epic-4
...
Validate the planned v0.4 `init --omni` scaffold contract, including strict-node file targets, core pin updates, and safe event guidance placement.
