...
id: task-81
type: task
title: plan toon output for discovery and show commands
status: todo
priority: 1
epic: epic-11
tags: [0_0_4x, cli, toon]
owners: []
links: []
artifacts: []
...
Plan TOON output support for discovery and show commands after JSON stabilizes.
