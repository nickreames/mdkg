...
id: test-25
type: test
title: v0.4 manual docs alignment audit contract
status: done
priority: 1
epic: epic-5
...
Validate presence and completeness of manual docs alignment audit guidance for v0.4.
...
- manual audit path is selected over scripted automation for v0.4
...
- Verify cadence expectations are documented for v0.4.x cuts.
...
- Reassess automation options for v0.5 if manual audit load grows.
