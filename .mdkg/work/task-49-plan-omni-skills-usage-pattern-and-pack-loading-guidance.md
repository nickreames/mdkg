...
Define recommended orchestrator usage of skills in Omni-style or other external-agent flows, including metadata-first discovery and full-body inclusion during execution.

# Acceptance Criteria

- Omni-style and external-orchestrator pattern is documented: select node -> load deterministic pack -> load relevant skill bodies -> execute -> write results/checkpoint.
