...
id: edd-8
type: edd
title: v0.4 external orchestrator minimal run event artifact contract
...
This document defines a minimal structured interoperability contract for external orchestrators (Omni-class and compatible systems) in v0.4 documentation.
...
1. lock docs contract in v0.4 planning graph
